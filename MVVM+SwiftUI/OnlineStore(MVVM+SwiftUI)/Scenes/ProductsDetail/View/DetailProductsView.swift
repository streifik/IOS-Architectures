...
struct DetailProductsView_Previews: PreviewProvider {
    static var previews: some View {
        DetailProductsView(detailProductsViewModel: DetailProductsViewModel(product: Product.sampleProduct), tabbBarHidden: .constant(true), parentViewName: "ProductsView")
    }
}
